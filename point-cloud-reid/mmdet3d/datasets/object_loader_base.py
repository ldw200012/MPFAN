...
class ObjectLoaderSparseNuscenes(ObjectLoaderSparseBase):
    def __init__(self,
                 ...
                 **kwargs):
        # print("CALLING ObjectLoaderSparseNuscenes ...")
        print("mp: ", metadata_path)
        ...
        # [(1, 2), (2, 4), (4, 8), (8, 16), (16, 32), (32, 64), (64, 128), (128, 256), (256, 512), (512, 1024), (1024, 2048), (2048, 4096), (4096, 8192), (8192, 16384), (16384, 32768), (32768, 65536), (65536, 131072), (131072, 262144), (262144, 524288), (524288, 1048576)] # 총 20개

        self.get_all_buckets(np.arange(0,len(self.obj_id_to_nums)))

        print("[ObjectLoaderSparseNuscenes] Loading buckets took: ",time.time()-t1)
    ...
    def __init__(self,
        ...
        for entry in os.listdir(base_path):
            ...
            if os.path.isdir(full_path):
                ...
                class_name = "boat" if entry.startswith("FP") else "boat"
        ...
        # print("\033[91mObjectLoaderSparseJeongok Created >>>\033[0m")
        # print("\033[91mself.obj_infos type: \033[0m", type(self.obj_infos))
        # print("\033[91mself.obj_infos len: \033[0m", len(self.obj_infos))
        # start = len(self.obj_infos) - 3
        # start = max(start, 0)
        # print("\033[91mself.obj_infos sample: \033[0m", dict(islice(self.obj_infos.items(), 3)), "...", dict(islice(self.obj_infos.items(), start, None)))

        # ObjectLoaderSparseJeongok Created >>>
        # self.obj_infos type:  <class 'dict'>
        # self.obj_infos len:  10
...
class ObjectLoaderCompleteNuscenes(Loader):
    ...
    def __init__(self,train,version,metadata_path,*args,**kwargs):
        ...
        super().__init__(*args,metadata=metadata,**kwargs)
        print("ObjectLoaderCompleteNuscenes created")
