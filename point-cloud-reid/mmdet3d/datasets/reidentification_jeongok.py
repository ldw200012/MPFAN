...
class ReIDDatasetJeongok(ReIDDatasetBase):
    def __init__(self,*args,**kwargs):
        ...
        print("\033[91mReIDDatasetJeongok Created >>>\033[0m")
        # print("\033[91mself.instance_token_to_id length: \033[0m", len(self.instance_token_to_id))
        # print("\033[91mself.instance_token_to_id sample: \033[0m", self.instance_token_to_id)

        # ReIDDatasetNuscenesFP Created >>>
        # self.instance_token_to_id length:  8
        # self.instance_token_to_id sample:  {'target4': 0, 'target2': 1, 'target3': 2, 'target8': 3, 'target6': 4, 'target1': 5, 'target7': 6, 'target5': 7}

        super().__init__(*args, **kwargs)

        self.obj_tokens = list(self.sparse_loader.obj_id_to_nums.keys())
        # print("\033[91mReIDDatasetNuscenesFP self.obj_tokens >>>\033[0m")

        self.collect_dataset_idx()
        # print("\033[91mReIDDatasetNuscenesFP self.collect_dataset_idx >>>\033[0m")

        self.maintain_api()
        # print("\033[91mReIDDatasetNuscenesFP self.maintain_api >>>\033[0m")

        self.vis_to_cls_id = {1:0,2:1,3:2,4:3}
        # print("\033[91mReIDDatasetNuscenesFP self.vis_to_cls_id >>>\033[0m")
...
class ReIDDatasetJeongokValEven(ReIDDatasetJeongok):
    ...
    def __init__(self,max_combinations,test_mode,*args,**kwargs):
        ...
        super().__init__(*args, **kwargs)
        print("\033[91mReIDDatasetJeongokValEven Created >>>\033[0m")
    ...
    def after_collect_dataset_idx_hook(self):
        ...
        # print("self.fp_buckets: ", self.fp_buckets)
        ...
        print("fp_buckets_filtered: ", fp_buckets_filtered)
        ...
        print("self.tp_buckets: ", self.tp_buckets)
