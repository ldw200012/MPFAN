_base_ = [
    ...
    "../_base_/reidentifiers/reid_pts_dgclonext_point-cat.py",
]

model = dict(
    type='ReIDNet',

    # backbone=dict(type='DGCloneXt', nsample=[16,16,16]),
    backbone=dict(type='ED_Ptr_DG', nsample=[16,16,16], ED_nsample=10, ED_conv_out=8),
