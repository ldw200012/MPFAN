num_classes  = 10 * 2
output_feat_size = 128 # (original) = 64
SA_feat_size = 128
...
model = dict(
    ...
    backbone=dict(type='ConcatCloneNeXt',input_channels=0,use_xyz=True,SA_conv_out=SA_feat_size, conv_out=output_feat_size,
                                                k=40,normal_channel=False,
                                                nhead=8, attention='linear'),
