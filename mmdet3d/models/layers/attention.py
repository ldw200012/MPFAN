...
class cross_attention(nn.Module):
    ...
    def forward(self, search_feat, search_xyz, template_feat, template_xyz, mask=None):
        ...
        # print("SEARCH FEAT: ", search_feat.shape)
        ...
        # print("\033[91mtemplate_feat_pos: \033[0m", template_xyz.shape, self.pos_mlp(template_xyz).shape, template_feat.shape)
...
class local_self_attention(nn.Module):
    ...
    def forward(self, search_feat, search_xyz, mask=None):
        ...
        # position embedding
        # print(search_xyz.view(bs*ns, 1, 3).shape, search_feat.shape)
