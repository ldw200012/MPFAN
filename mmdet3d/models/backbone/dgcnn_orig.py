...
code below this line is taken/modified from https://github.com/WangYueFt/dgcnn/blob/master/pytorch/model.py
"""
...
def get_graph_feature(x, k=20, idx=None):
    ...
    # print("Graph X Shape: ", x.shape) # delete-print
    if idx is None:
...
class DGCNN(nn.Module):
    def __init__(self,dropout=0.5,emb_dims=1024, k=20, output_channels=40):
        ...
        print("\033[91mDGCNN Created\033[0m")
    ...
    def forward(self, xyz, backbone_list):
        ...
        # x1 = F.adaptive_max_pool1d(feats, 1).view(batch_size, -1)
        # x2 = F.adaptive_avg_pool1d(feats, 1).view(batch_size, -1)
        # x = torch.cat((x1, x2), 1)
