...
model = dict(
    ...
    backbone=dict(type='DGCNN', emb_dims=downsample_input),
    # backbone=dict(type='DGCNN_6C', emb_dims=downsample_input),
    # backbone=dict(type='ED_DGCNN', emb_dims=downsample_input, ED_conv_out=8),
