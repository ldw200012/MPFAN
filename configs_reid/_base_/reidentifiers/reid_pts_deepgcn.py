...
model = dict(
    ...
    backbone=dict(type='DeepGCN_6C', emb_dims=output_feat_size, use_precomputed_eigen=True),
    # backbone=dict(type='ED_DeepGCN', emb_dims=output_feat_size, use_precomputed_eigen=True),
